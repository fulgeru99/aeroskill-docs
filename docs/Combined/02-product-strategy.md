...
```mermaid
flowchart LR
    A["What Romanians already<br/>pay for and trust"] --> B["ACR — 200–250 RON/yr<br/>card, assistance, reciprocity"]
    B --> C["Aeroskill Club — 3000/4500/6000 RON/yr<br/>card, contracted discounts, community"]
    C --> D["The step up IS the product:<br/>purchasing power in a hobby<br/>priced at €120–145/hour"]
```
