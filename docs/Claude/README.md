...
|---|----------|-----------------|
| 0 | [00-foundation.md](00-foundation.md) | The canonical decisions everything else inherits — read first |
| 1 | [01-product-vision.md](01-product-vision.md) | Why we exist, who we serve, what success looks like |
| 2 | [02-product-strategy.md](02-product-strategy.md) | Positioning, tier & sponsor strategy, monetization, GTM, risks |
| 3 | [03-implementation-plan.md](03-implementation-plan.md) | Build philosophy, scope slices, milestones, solo Claude Code workflow |
| 4 | [04-prd.md](04-prd.md) | Detailed requirements per surface, with IDs & acceptance criteria |
| 5 | [05-information-architecture.md](05-information-architecture.md) | Sitemap, navigation, URL/i18n structure, RBAC access map |
| 6 | [06-database-schema.md](06-database-schema.md) | Entities, columns, relationships, ERD, RLS posture |
| 7 | [07-user-flows.md](07-user-flows.md) | Step-by-step flows across all three surfaces |
| 8 | [08-design-system.md](08-design-system.md) | Logo-driven brand, tokens, type, components, member card |
| 9 | [09-technical-infrastructure.md](09-technical-infrastructure.md) | Stack, services, environments, security/GDPR, deployment |
| 10 | [10-roadmap.md](10-roadmap.md) | Sequenced solo Claude Code build roadmap, phase by phase |
